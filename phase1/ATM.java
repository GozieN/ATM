...
public class ATM {
    ...
    public void main (String[] args) {
        ...
        try{
            ...
            if (this.num50bills < 20){originalOut.println("Five dollar bills low in stock!");}
            else if (this.num10bills < 20) {originalOut.println("Ten dollar bills low in stock!");}
            else if (this.num20bills < 20) {originalOut.println("Twenty dollar bills low in stock!");}
            else if (this.num50bills < 20) {originalOut.println ("Fifty dollar bills low in stock!");}

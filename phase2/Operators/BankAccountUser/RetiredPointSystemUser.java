...
public class RetiredPointSystemUser extends PointSystemUser{
    ...
    public String viewCapabilities(){
        String s = "";
        s = "As a new Retired Point System User, the following applies: \n" +
                "- Gain an initial 120 points.\n" +
                "- Have your points cashed automatically.\n" +
                "- Assign co-account owner\n" +
    ...
    public String viewContract(){
        String s = "";
        s = "As a Retired Point System User of the Bank, " +
